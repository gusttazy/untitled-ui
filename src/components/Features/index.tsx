    ...
    <section className="py-24">
      <GridContainer>
        <div className="text-center mb-16">
          <small className="block text-base text-[#6246ea] font-semibold mb-3">
            Features
          </small>
        ...
        <div className="grid grid-cols-3 gap-x-8 gap-y-16">
          ...
          <ItemFeature
            ...
            text="An all-in-one customer service platform that helps you balance everything your customers need to be happy.h"
          />
          <ItemFeature
            icon={<FiBarChart2 size={24} className="text-[#6246ea]" />}
            title="Manage your team with reports"
            text="Measure what matters with Untitled’s easy-to-use reports. You can filter, export, and drilldown on the data in a couple clicks.h"
          />
          <ItemFeature
